...
def scrape_hackathon_challenges(url):
    ...
    try:
        ...
        # === 4) 嘗試定位到表格 - 找到包含"命題目標"和"命題企業"的表格 ===
        target_table = None
...
if __name__ == "__main__":
    ...
    # === 8) 輸出結果 (Python格式，可直接複製到step2程式中) ===
    print("\n爬取完成! 命題數量:", len(challenges))
    print("\n===== 請複製以下內容到step2_scrape_details.py的challenges變數中 =====\n")
    print("challenges = [")
